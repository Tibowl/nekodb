...
function RenderList({ nodes }: { nodes: NodeItem[] }) {
...
type NodeItem = TextNode | ElementNode
interface TextNode { type: "text", value: string }
interface ElementNode { type: "element", tag: string, value?: string, children: NodeItem[] }

type ParseNode = NodeItem & { state?: any }
function parse(text: string): NodeItem[] {
